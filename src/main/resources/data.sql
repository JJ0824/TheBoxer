...
VALUES ('루틴 관리', true, '운동 루틴을 어떻게 관리하고 계신가요? 효과적인 루틴을 함께 나누고 피드백을 주고받으면 좋겠습니다.', 'user1', '2025-03-14', '질문', 0, 0),
('식단 팁', true, '체중 감량을 위한 식단 조절 방법에 대해 이야기해봅시다. 식단 관리의 꿀팁을 공유해주세요!', 'user', '2025-03-14', '질문', 0, 0);
